...

{
    public partial class Student : Form
    {
        ...
        private void Btn1Generate_Click(object sender, EventArgs e)
        {
            //Generating Barcode
            Zen.Barcode.CodeQrBarcodeDraw brcode = Zen.Barcode.BarcodeDrawFactory.CodeQr;
            pictureBoxBRC.Image = brcode.Draw(txtLast.Text + "_" + txtFirst.Text + "_" + dateTimeDOB.Text + "_" + txtSchoolYear.Text, 5, 5);
            UFdoc.Image = brcode.Draw(comboBoxSelect.Text + "_" + lblStudent.Text, 1, 1);
        ...
        private void PrintDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("Form Info:  " + lblStudent.Text + " " + comboBoxSelect.Text, new Font("Calibri", 14, FontStyle.Bold), Brushes.Black, new PointF(500,45));
            ...
            e.Graphics.DrawString("DOB:" +" "+ dateTimeDOB.Text, new Font("Calibri", 14, FontStyle.Bold), Brushes.Black, new PointF(200, 325));

            e.Graphics.DrawString("First Name:" + " " + txtFirst.Text, new Font("Calibri", 14, FontStyle.Bold), Brushes.Black, new PointF(500, 275));
            e.Graphics.DrawString("School Year:" +" "+ txtSchoolYear.Text, new Font("Calibri", 14, FontStyle.Bold), Brushes.Black, new PointF(500, 325));
            ...
            
        {
            ...
            if (string.IsNullOrEmpty(txtSchoolYear.Text))
            {
                ...
                txtSchoolYear.Focus();
                errorProvider1.SetError(txtSchoolYear, "Please Enter Year");
            }
        ...
        private void StudentRecordToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            this.Hide();
